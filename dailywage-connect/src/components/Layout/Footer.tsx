      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">DailyWageConnect</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Connecting households with skilled daily-wage workers. Empowering workers with job opportunities and giving families access to reliable help.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/workers" className="text-gray-300 hover:text-white transition-colors">Find Workers</Link></li>
              <li><Link to="/tools" className="text-gray-300 hover:text-white transition-colors">Browse Tools</Link></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-gray-400 text-sm md:mt-0 md:order-1">
            &copy; 2024 DailyWageConnect. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
